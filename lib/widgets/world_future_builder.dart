...
class WorldFutureBuilder extends StatelessWidget {
    ...
    return FutureBuilder(
      ...
      builder: (context, AsyncSnapshot<WorldStatesModel> snapshot) {
        if(!snapshot.hasData){
          ...
          if(isTodaySelected){
            cases = NumberFormat.decimalPattern().format(snapshot.data!.todayCases);
            deaths = NumberFormat.decimalPattern().format(snapshot.data!.todayDeaths);
            recovered = NumberFormat.decimalPattern().format(snapshot.data!.todayRecovered);
            active = NumberFormat.decimalPattern().format(snapshot.data!.active);
            critical = NumberFormat.decimalPattern().format(snapshot.data!.critical);
          }else{
            cases = NumberFormat.decimalPattern().format(snapshot.data!.cases);
            deaths = NumberFormat.decimalPattern().format(snapshot.data!.deaths);
            recovered = NumberFormat.decimalPattern().format(snapshot.data!.recovered);
            active = NumberFormat.decimalPattern().format(snapshot.data!.active);
            critical = NumberFormat.decimalPattern().format(snapshot.data!.critical);
          }
          return Container(
